...
const gcResults = [
  ...
  {id:'astwerk',name:'Astwerk',company:'Astwerk Niels Beyer GmbH',branch:'Baumpflege',count:2,role:'Facharbeiter',hires:['2 Facharbeiter'],note:'Zwei Facharbeiter verstärken Astwerk Niels Beyer GmbH.',photo:[650,355,472,640],logo:[65,640,390,126]},
  ...
  {id:'blumenkamp',name:'Blumenkamp',company:'Gartenservice Blumenkamp',branch:'Garten- & Landschaftsbau',count:1,role:'Landschaftsgärtner',hires:['1 Landschaftsgärtner'],note:'Ein Landschaftsgärtner verstärkt Gartenservice Blumenkamp.',photo:[645,450,477,572],logo:[58,713,331,95]},
  {id:'deine-lieblingsgaertner',name:'Deine Lieblingsgärtner',company:'Deine Lieblingsgärtner J.B. GmbH',branch:'Garten- & Landschaftsbau',count:1,role:'Facharbeiter im GaLaBau',hires:['1 Facharbeiter im GaLaBau'],note:'Ein Facharbeiter im Garten- und Landschaftsbau wurde eingestellt.',photo:[350,620,560,420],logo:[176,466,338,151]},
  {id:'goldblume',name:'Goldblume',company:'Goldblume Garten und Landschaftsbau',branch:'Garten- & Landschaftsbau',count:1,role:'Landschaftsgärtner',hires:['1 Landschaftsgärtner'],note:'Ein Landschaftsgärtner verstärkt das Team von Goldblume.',photo:[560,435,562,555],logo:[100,640,282,183]},
